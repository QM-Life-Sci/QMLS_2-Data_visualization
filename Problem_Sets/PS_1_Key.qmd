...
> The slope of the coefficient for `year` is -30.6 which is significantly different from 0. We would conclude that the number of lynx pelts decreases by about 30 per year. If the Hudson's Bay Company had been around at year 0, it would have collected over 56,000 pelts.
...
PPcts |>
  ggplot(aes(x = Place_Time, Counts, fill = Presence)) +
